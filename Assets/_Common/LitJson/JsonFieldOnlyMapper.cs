...
namespace LitJson
{
    public class JsonFieldOnlyMapper
    {
        #region Fields
...
//            }
                ...
                )
            {
				...
				if (!f_info.IsStatic && !f_info.IsNotSerialized) {
					PropertyMetadata p_data = new PropertyMetadata ();
					p_data.Info = f_info;
					p_data.IsField = true;
                                        ...
                                        int depth)
        {
            ...
            foreach (PropertyMetadata p_data in props) {
                if (p_data.IsField) {
//					string msg = "Property name = " + p_data.Info.Name;
